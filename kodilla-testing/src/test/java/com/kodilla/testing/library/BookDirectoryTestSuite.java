...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandsOfNoneBorrowed() {
        ...
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        List<Book> resultListOfBooks = new ArrayList<>();
        LibraryUser user = new LibraryUser("Jan", "Kowalski", "8525067785");
        ...
        //Then
        assertTrue(theListOfBooks0.isEmpty());
    }
    ...
    public void testListBooksInHandsOfBorrowedOne() {
        ...
        // When
        List<Book> theListOfOneBook = bookLibrary.listBooksinHandsOf(user);

        // Then
        assertEquals(1, theListOfOneBook.size());
        assertEquals(resultListOfOneBook, theListOfOneBook);
    }
    ...
    public void testListBooksInHandsOfBorrowed5Books() {
        ...
        assertEquals(resultListOfFiveBooks, theListOfBooks5);
    }
